...
const functionCallRequest = {
    scopes: ["api://fab9c389-3f00-4541-8100-eeccd7630732/user_impersonation"]
};
...
function callMyFunction(accessToken) {
    ...
    xmlHttp.open("GET", "https://helloworldfunction1123.azurewebsites.net/api/powershell-azure-function-helloworldHttpTrigger" , true); // true for asynchronous
